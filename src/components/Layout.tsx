...
export default function Layout() {
  ...
  const isDetailView = isMessageView || isProfileView;
  ...
  return (
    <div className="flex h-screen bg-background text-foreground overflow-hidden">
      {/* Sidebar */}
      <div
        className={`flex flex-col w-full md:w-80 border-r bg-muted/10 shrink-0 ${isDetailView ? "hidden md:flex" : "flex"}`}
      >
        <div
          className="p-4 border-b flex items-center justify-between gap-2 shadow-sm cursor-pointer hover:bg-muted/30 transition-colors"

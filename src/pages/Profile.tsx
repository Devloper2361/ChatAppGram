        ...
        <div className="max-w-xl mx-auto md:ml-0 md:mx-0 w-full space-y-8">
          <div className="flex flex-col items-center sm:items-start sm:flex-row gap-6">
             <div className="relative group shrink-0">
                ...
                <div onClick={() => fileInputRef.current?.click()} className="absolute inset-0 bg-black/40 flex items-center justify-center rounded-full opacity-0 group-hover:opacity-100 transition-opacity cursor-pointer">
             ...
             <div className="flex flex-col gap-2 mt-2 items-center sm:items-start object-contain">
               ...
               <div className="flex gap-2 mt-1">
                 ...
                 {avatarBase64 && <Button variant="destructive" size="sm" onClick={handleRemoveAvatar}>Remove</Button>}
               </div>
             </div>
          </div>
          ...
          <form onSubmit={saveProfile} className="space-y-6">
             <div className="space-y-2">
               ...
               <p className="text-xs text-muted-foreground">You can't change your username</p>
             </div>
             
             <div className="space-y-2">
               <label className="text-sm font-medium">Display Name</label>
               <Input value={displayName} onChange={(e) => setDisplayName(e.target.value)} placeholder="Your display name" maxLength={50} />
             </div>
             
             <div className="space-y-2">
               <label className="text-sm font-medium">Bio</label>
               <Textarea value={bio} onChange={(e) => setBio(e.target.value)} placeholder="A little bit about yourself" rows={4} maxLength={200} />
             </div>
